...
Must live at mortality_transforms.py relative to the Python path root so that
pickle can find mortality_transforms.Log1pSelectedColumns and
mortality_transforms.SqrtSelectedColumns when deserializing mortality_pipeline.pkl.

Source: Mortality_LOS_Models/Frontend/lib/models/mortality_transforms.py
"""
